  ...
  <?php include("../../app/include/sidebar-admin.php");?>
        <div class="posts col-9">
            ...
            <div class="row post">
                ...
                <div class="red col-2"><a class="btn btn-outline-info" href="edit.php?id=<?=$category['id'];?>">Изменить</a></div>
                <div class="del col-2"><a class="btn btn-outline-danger" href="edit.php?del_id=<?=$category['id'];?>">Удалить</a></div>
            </div>
           <?php endforeach; ?>
        </div>
    </div>
