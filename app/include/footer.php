  ...
  <div class="container mt-2">
    <div class="row div_foot_row">
      ...
      <h3>О компании</h3>
          <ul class="nav flex-column footer__ul">
            <li class="nav-item">
              <a class="nav-link" href="<?php echo BASE_URL . 'contacts.php'?>">Контактная информация</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="<?php echo BASE_URL . 'payment.php'?>">Оплата</a>
            </li>
          </ul>                  
      </div>
      <div class="col-12 col-sm-12 col-md-3 py-sm-4 py-md-5 div_foot_text foot_md">  
        <h3>+7 (4852) 14-22-55</h3>
          <ul class="nav flex-column sidebar__ul ">
            ...
            <li class="nav-item">
              <p class="foot-p" >Если у вас есть вопросы, напишите нам в чат или на oxapkin_nikita@mail.ru</p>
            </li>
            <li class="nav-item">
              <p class="foot-p" >oxapkin_nikita@mail.ru Никита Охапкин, руководитель отдела закупок</p>
            </li>
          </ul>                  
      </div>
          ...
          <ul class="nav flex-row sidebar__ul foot_social">
            <li class="nav-item ">
              <a class="nav-link " href="#">
                <img src="image/telegram.png" class=" d-inline-block " width="30" height="30" alt="Аккаунт" loading="lazy">
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#">
                <img src="image/vk.png" class=" d-inline-block" width="30" height="30" alt="Аккаунт" loading="lazy">
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#">
                <img src="image/watsaap.png" class=" d-inline-block" width="30" height="30" alt="Аккаунт" loading="lazy">
              </a>
            </li>
          </ul>                  
      </div>
